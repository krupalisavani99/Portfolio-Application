...
const Skill = ({ name, x, y }) => {
  return (
    <motion.div
      ...
      bg-black text-white py-3 px-6 shadow-black cursor-pointer absolute 
...
const Skills = () => {
  return (
    <>
      <h2 className="font-bold text-6xl mt-58 w-full text-center md:text-5xl md:mt-32">
        Skills
      </h2>
      <div
      ...
      >
        <motion.div
          className="flex items-center justify-center rounded-full font-semibold
        bg-black text-white p-8 shadow-black cursor-pointer lg:p-6 md:p-4 xs:text-xs xs:p-2 "
          whileHover={{ scale: 1.05 }}
        >
          Web
        </motion.div>
